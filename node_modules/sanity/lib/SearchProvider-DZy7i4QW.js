import { r as Popover$1 } from "./ConfirmPopover-CD1rDyuk.js";
...
import { c as useWorkspace, i as useClient, n as DEFAULT_STUDIO_CLIENT_OPTIONS, o as useSource } from "./studioClient-DVccfDG9.js";
import { a as useGrantsStore, gn as useSchema, l as useProjectStore, mn as isRecord, p as useCurrentUser, r as useDocumentPreviewStore, s as useKeyValueStore, u as useRenderingContextStore } from "./datastores-BncX_uvZ.js";
import { t as useTranslation } from "./useTranslation-Cqs6Itwv.js";
import { An as SanityDefaultPreview, Co as DocumentStatus, Dn as useSearchMaxFieldDepth, Fn as supportsTouch, Ni as truncateString, On as createSearch, So as DocumentStatusIndicator, Yn as useValuePreview, _o as PreviewCard, hn as getDocumentVersionInfoFromVersions, is as getPreviewStateObservable, mn as useDocumentPresence, ss as EMPTY_ARRAY, vi as useDocumentVersions, wo as useActiveReleases, xn as DocumentPreviewPresence } from "./useBundleDocuments-DpiMoPsr.js";
import { o as TextWithTone } from "./ContextMenuButton-CruB3rT2.js";
...
import { Badge, Box, Button, Card, Code, Container, Flex, Inline, Menu, MenuDivider, Portal, Stack, Text, TextInput, rem, studioTheme, useClickOutsideEvent, useGlobalKeyDown, useLayer, useMediaIndex } from "@sanity/ui";
...
const INITIAL_PREVIEW_STATE = {
	...
	isLoading: !0,
	original: null
}, SearchResultItemPreviewBox = styled(Box).withConfig({
...
function SearchResultItemPreview(t0) {
	let $ = c(41), { documentId, documentType, layout, presence, schemaType, showBadge: t1, perspective, variant } = t0, showBadge = t1 === void 0 || t1, documentPreviewStore = useDocumentPreviewStore(), t2;
	...
	bb0: {
		...
		let t7;
		$[13] === presence ? t7 = $[14] : (t7 = presence && presence.length > 0 && /* @__PURE__ */ jsx(DocumentPreviewPresence, { presence }), $[13] = presence, $[14] = t7);
		let t8;
		$[15] !== schemaType.title || $[16] !== showBadge ? (t8 = showBadge && /* @__PURE__ */ jsx(Badge, { children: schemaType.title }), $[15] = schemaType.title, $[16] = showBadge, $[17] = t8) : t8 = $[17];
		let t9;
		$[18] !== versionsInfo.draft || $[19] !== versionsInfo.published || $[20] !== versionsInfo.versions ? (t9 = /* @__PURE__ */ jsx(DocumentStatusIndicator, {
			draft: versionsInfo.draft,
			published: versionsInfo.published,
			versions: versionsInfo.versions
		}), $[18] = versionsInfo.draft, $[19] = versionsInfo.published, $[20] = versionsInfo.versions, $[21] = t9) : t9 = $[21];
		let t10;
		$[22] !== t7 || $[23] !== t8 || $[24] !== t9 ? (t10 = /* @__PURE__ */ jsxs(Flex, {
			align: "center",
			gap: 3,
			children: [
				t7,
	...
	let status = t6, t7;
	$[26] !== versionsInfo.draft || $[27] !== versionsInfo.published || $[28] !== versionsInfo.versions ? (t7 = /* @__PURE__ */ jsx(DocumentStatus, {
		draft: versionsInfo.draft,
		published: versionsInfo.published,
		versions: versionsInfo.versions
	...
	return $[34] !== schemaType.icon || $[35] !== status || $[36] !== t10 || $[37] !== t8 || $[38] !== t9 || $[39] !== tooltip ? (t11 = /* @__PURE__ */ jsx(SearchResultItemPreviewBox, { children: /* @__PURE__ */ jsx(SanityDefaultPreview, {
		...t8,
		isPlaceholder: t9,
		layout: t10,
...
function SearchResultItem(t0) {
	...
	let t18;
	$[61] !== rest || $[62] !== t17 ? (t18 = /* @__PURE__ */ jsx(Box, {
		...rest,
		children: t17
	...
	return $[67] !== content || $[68] !== disabledAction || $[69] !== tooltipContent ? (t20 = disabledAction ? /* @__PURE__ */ jsx(Tooltip$1, {
...
const CustomTextInputBox = /* @__PURE__ */ styled(Box).withConfig({
...
const SearchHeaderBox = styled(Box).withConfig({
...
function FilterDetails(t0) {
	...
	if ($[0] !== definitions.fields || $[1] !== filter) {
		...
		T0 = Stack, t2 = 2, t3 = fieldDefinition?.titlePath && fieldDefinition.titlePath?.length > 1 && /* @__PURE__ */ jsx(Box, {
			marginLeft: 4,
	...
	let t5;
	$[6] === filter ? t5 = $[7] : (t5 = /* @__PURE__ */ jsx(Box, {
		style: t4,
		children: /* @__PURE__ */ jsx(Text, {
			size: 1,
...
function FilterTooltip(t0) {
	...
	if ($[0] !== documentTypesNarrowed.length || $[1] !== fieldDefinition || $[2] !== filterDefinition || $[3] !== schema || $[4] !== t) {
		...
		if ($[16] !== fieldDefinition || $[17] !== schema || $[18] !== t) {
			...
			T2 = Tooltip$1, T1 = Card, t7 = "default", t8 = 2, $[35] === Symbol.for("react.memo_cache_sentinel") ? (t9 = { maxWidth: "250px" }, $[35] = t9) : t9 = $[35], T0 = Stack, t2 = 4, $[36] !== fieldDefinition || $[37] !== t ? (t3 = fieldDefinition && /* @__PURE__ */ jsxs(Stack, {
				gap: 3,
				children: [/* @__PURE__ */ jsx(Text, {
					muted: !0,
					size: 1,
...
const MenuItemFilter = memo(function MenuItemFilter(t0) {
	...
	let t6 = item?.tone, t7;
	$[14] === item.filter ? t7 = $[15] : (t7 = /* @__PURE__ */ jsx(Box, {
		padding: 3,
	...
	let t10;
	return $[26] !== rest || $[27] !== t9 ? (t10 = /* @__PURE__ */ jsx(Box, {
		...rest,
		children: t9
	...
	let t3;
	return $[2] !== t1 || $[3] !== t2 ? (t3 = /* @__PURE__ */ jsx(Box, {
		paddingTop: 1,
		children: /* @__PURE__ */ jsx(Card, {
			borderBottom: !0,
			paddingX: 2,
...
function AddFilterPopoverContent(t0) {
	...
	let t12;
	$[29] !== filteredMenuItems.length || $[30] !== t || $[31] !== titleFilter ? (t12 = filteredMenuItems.length == 0 && /* @__PURE__ */ jsx(Box, {
		padding: 3,
		children: /* @__PURE__ */ jsx(Text, {
			muted: !0,
			size: 1,
...
function AddFilterButton() {
	...
	let t10;
	return $[14] !== open || $[15] !== t6 || $[16] !== t9 ? (t10 = /* @__PURE__ */ jsx(Popover$1, {
...
const DocumentTypeFilterItem = memo(function TypeFilterItem(t0) {
	...
	let t9;
	return $[20] !== rest || $[21] !== t8 ? (t9 = /* @__PURE__ */ jsx(Box, {
		...rest,
		children: t8
	}), $[20] = rest, $[21] = t8, $[22] = t9) : t9 = $[22], t9;
}), ClearButtonBox = styled(Box).withConfig({
...
function DocumentTypesPopoverContent() {
	...
	let t11;
	$[22] !== documentTypeItems.length || $[23] !== t || $[24] !== typeFilter ? (t11 = !documentTypeItems.length && /* @__PURE__ */ jsx(Box, {
		padding: 3,
		children: /* @__PURE__ */ jsx(Text, {
			muted: !0,
			size: 1,
...
function _temp$6(item) {
	return item.type === "divider" ? /* @__PURE__ */ jsx(Box, {
		paddingY: 1,
		children: /* @__PURE__ */ jsx(MenuDivider, {})
	}) : item.type === "header" ? /* @__PURE__ */ jsx(Box, {
		margin: 2,
		padding: 1,
		children: /* @__PURE__ */ jsx(Text, {
			muted: !0,
...
function DocumentTypesButton() {
	...
	let t11;
	return $[15] !== open || $[16] !== t10 || $[17] !== t8 ? (t11 = /* @__PURE__ */ jsx(Popover$1, {
...
function FilterError(props) {
	...
	let t6;
	return $[12] !== props || $[13] !== t5 ? (t6 = /* @__PURE__ */ jsx(Box, {
		...props,
		children: t5
...
function FilterForm(t0) {
	...
	let t10;
	$[25] === filter ? t10 = $[26] : (t10 = /* @__PURE__ */ jsx(Box, {
		paddingLeft: 1,
		paddingRight: 2,
		paddingY: 1,
...
function FilterButton(t0) {
	...
	let t20;
	return $[41] !== open || $[42] !== t10 || $[43] !== t19 ? (t20 = /* @__PURE__ */ jsx(Popover$1, {
...
function SearchHeader(t0) {
	...
	let t19;
	$[26] !== ariaLabel || $[27] !== fullscreen || $[28] !== handleQueryChange || $[29] !== handleQueryClear || $[30] !== query || $[31] !== ref || $[32] !== t15 || $[33] !== t17 || $[34] !== t18 ? (t19 = /* @__PURE__ */ jsx(Box, {
		flex: 1,
		children: /* @__PURE__ */ jsx(CustomTextInput, {
			__unstable_disableFocusRing: !0,
...
})`border-radius:${({ theme }) => rem(theme.sanity.radius[2])};cursor:default;width:100%;`, SearchItemPillsBox = styled(Box).withConfig({
...
function RecentSearchItem(t0) {
	...
	let t13;
	return $[34] !== rest || $[35] !== t12 ? (t13 = /* @__PURE__ */ jsx(Box, {
		...rest,
		children: t12
...
function RecentSearches(t0) {
	...
	$[6] !== filtersVisible || $[7] !== fullscreen || $[8] !== handleClearRecentSearchesClick || $[9] !== inputElement || $[10] !== recentSearches || $[11] !== renderItem || $[12] !== t ? (t6 = recentSearches.length > 0 ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
		...
		/* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(CommandList, {
			activeItemDataAttr: "data-hovered",
...
function SearchError() {
	...
	$[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ jsx(Box, {
		marginBottom: 1,
		children: /* @__PURE__ */ jsx(TextWithTone, {
			tone: "critical",
...
function DebugOverlay(t0) {
	...
	if ($[0] !== data.stories) {
		...
		T1 = Tooltip$1, T0 = Stack, t1 = 2, t2 = matchingStories.length ? /* @__PURE__ */ jsx(Fragment$1, { children: matchingStories.map(_temp2) }) : /* @__PURE__ */ jsx(Code, {
			size: 0,
			children: "No matches"
...
//# sourceMappingURL=SearchProvider-DZy7i4QW.js.map