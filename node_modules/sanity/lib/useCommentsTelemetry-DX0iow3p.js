import { o as Tooltip$1 } from "./MenuItem-BWdL61CI.js";
import { t as useTranslation } from "./useTranslation-Cqs6Itwv.js";
import { _ as applyCommentsGroupAttr, b as commentsLocaleNamespace, d as hasCommentMessageValue, o as CommentInput } from "./useComments-D_nSQUGP.js";
import { n as ThreadCard, t as CommentsListItem } from "./CommentsListItem-C1qIKAOP.js";
...
import { BoundaryElementProvider, Box, Button, Container, Flex, Stack, Text } from "@sanity/ui";
...
function CommentsListStatus(props) {
	...
	if (error) {
		...
		let t2;
		return $[4] === t1 ? t2 = $[5] : (t2 = /* @__PURE__ */ jsx(Flex, {
			align: "center",
			justify: "center",
			flex: 1,
			padding: 4,
	...
	if (hasNoComments) {
		...
		let t5;
		return $[14] !== t2 || $[15] !== t4 ? (t5 = /* @__PURE__ */ jsx(Flex, {
			align: "center",
			justify: "center",
			flex: 1,
			sizing: "border",
...
}), renderItem = (item, index) => /* @__PURE__ */ jsx(Box, {
	as: "li",
	children: /* @__PURE__ */ jsx(Text, {
...
function CommentBreadcrumbs(props) {
	...
	if ($[5] !== items) {
		...
		$[7] === items.length ? t2 = $[8] : (t2 = (item, index) => {
			...
			return Array.isArray(item) ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Tooltip$1, {
	...
	let nodes = t1, t2;
	return $[9] === nodes ? t2 = $[10] : (t2 = /* @__PURE__ */ jsx(Flex, {
		align: "center",
		as: "ol",
		gap: 2,
		children: nodes
...
const HeaderFlex = styled(Flex).withConfig({
...
})(({ theme }) => css`--card-fg-color:${theme.sanity.color.base.fg};max-width:100%;`);
...
function CommentsListInner(props) {
	...
	let t3;
	return $[29] !== t1 || $[30] !== t2 ? (t3 = /* @__PURE__ */ jsxs(Flex, {
...
//# sourceMappingURL=useCommentsTelemetry-DX0iow3p.js.map