import { CSSProperties, ClipboardEventHandler, Component, ComponentProps, ComponentType, Dispatch, ElementType, ErrorInfo, FC, FocusEvent, FocusEventHandler, FormEvent, FormEventHandler, HTMLAttributes, HTMLProps, KeyboardEvent, PropsWithChildren, PureComponent, ReactElement, ReactNode, Ref, RefAttributes, RefObject, SVGProps, SetStateAction } from "react";
import { MonoTypeOperatorFunction, Observable, OperatorFunction, Subject } from "rxjs";
import { Autocomplete, AvatarPosition, AvatarProps, AvatarSize, AvatarStatus, BadgeProps, BadgeTone, BoxProps, Button, ButtonProps, ButtonTone, CardProps, DialogProps, HotkeysProps, MenuButtonProps, MenuItem, Placement, PopoverProps, ResponsivePaddingProps, ResponsiveWidthProps, TextProps, ThemeColorSchemeKey, ToastParams, TooltipProps } from "@sanity/ui";
import { FallbackNs } from "react-i18next";
import { DocumentDivergencesContextValue, DocumentLimitUpsellContextValue, FeedbackContext as FeedbackContext$1, FieldActionsContextValue, HoveredFieldContextValue, LocaleContextValue, SchedulesContext, SingleDocReleaseContextValue } from "sanity/_singletons";
...
import { FlatNamespace, KeyPrefix, Namespace, TFunction, TFunction as TFunction$1, TFunction as TFunction$2, i18n as i18n$1 } from "i18next";
...
import "@sanity/mutate/_unstable_store";
/**
...
/** @internal */
type ListenerEvent = MutationEvent | ReconnectEvent$1 | InitialSnapshotEvent | PendingMutationsEvent | WelcomeEvent$1 | WelcomeBackEvent$1 | ResetEvent$1;
/** @internal */
 ...
 * @hidden
 * @beta */
type DocumentVersionEvent = WithVersion<ReconnectEvent$1 | BufferedDocumentEvent | WelcomeEvent$1 | WelcomeBackEvent$1 | ResetEvent$1>;
/**
 * @hidden
 * @beta */
 ...
 * @internal
 */
declare const Rule$1: RuleClass;
/**
 * @hidden
 * @beta */
...
interface Action$1 extends NavbarActionBase {
  onAction: () => void;
  selected: boolean;
  title: string;
  render?: undefined;
 ...
 */
type NavbarAction = Action$1 | ActionWithCustomRender;
/**
 * @hidden
 * @beta */
 ...
 * @internal
 */
declare const CapabilityGate: ComponentType<Props$5>;
/** @internal */
...
declare function CommandListComponent({ ref, activeItemDataAttr, ariaLabel, ariaMultiselectable, autoFocus, canReceiveFocus, fixedHeight, focusRingOffset, getItemDisabled, getItemKey, getItemSelected, initialIndex, initialScrollAlign, inputElement, itemHeight, items, onEndReached, onEndReachedIndexOffset, onlyShowSelectionWhenActive, overscan, renderItem, testId, wrapAround, ...responsivePaddingProps }: CommandListProps & RefAttributes<CommandListHandle>): import("react").JSX.Element;
/**
 ...
 * @internal
 */
declare const ReferenceInputPreviewCard: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<Omit<any, "as" | keyof import("@sanity/ui").CardOwnProps> & import("@sanity/ui").CardOwnProps & {
  as?: ElementType | undefined;
} & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & RefAttributes<HTMLDivElement>, never> & Partial<Pick<Omit<any, "as" | keyof import("@sanity/ui").CardOwnProps> & import("@sanity/ui").CardOwnProps & {
  as?: ElementType | undefined;
} & Omit<HTMLProps<HTMLDivElement>, "as" | "height" | "ref"> & RefAttributes<HTMLDivElement>, never>>> & string & Omit<typeof PreviewCard, keyof import("react").Component<any, {}, any>>;
/**
 * @hidden
 * @beta */
 ...
 * @beta
 */
declare const AvatarSkeleton: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("styled-components").FastOmit<Omit<import("@sanity/ui").SkeletonProps & Omit<import("react").HTMLProps<HTMLDivElement>, "height">, "ref"> & RefAttributes<HTMLDivElement>, "$size"> & AvatarSkeletonProps, never> & Partial<Pick<import("styled-components").FastOmit<Omit<import("@sanity/ui").SkeletonProps & Omit<import("react").HTMLProps<HTMLDivElement>, "height">, "ref"> & RefAttributes<HTMLDivElement>, "$size"> & AvatarSkeletonProps, never>>> & string & Omit<import("react").ForwardRefExoticComponent<Omit<import("@sanity/ui").SkeletonProps & Omit<import("react").HTMLProps<HTMLDivElement>, "height">, "ref"> & RefAttributes<HTMLDivElement>>, keyof import("react").Component<any, {}, any>>;
/**
 * @hidden
 * @beta */
...
/** @internal */
declare function getItemKey$1(arrayItem: unknown): string | undefined;
/** @internal */
 ...
 * @internal
 */
declare const FormCell: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("styled-components").FastOmit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "$area"> & Props$4, never> & Partial<Pick<import("styled-components").FastOmit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "$area"> & Props$4, never>>> & string;
/**
 * @internal
 */
...
type Props$3 = PropsEnabled | PropsDisabled;
/**
 * @internal
 */
declare const DivergencesProvider: ComponentType<Props$3>;
/**
 * @internal
 */
 ...
 * @hidden
 */
interface CopyOptions extends BaseOptions$1 {
  patchType?: 'replace' | 'append';
}
/**
 * @beta
 * @hidden
 */
interface PasteOptions extends BaseOptions$1 {}
/**
 * @beta
 * @hidden
 */
...
export { getVariantPublishedSibling as $, MarkdownConfig as $C, LocalesBundlesOption as $S, DocumentFieldActionItem as $T, DocumentActionsResolver as $_, ReleaseAvatar as $a, StringDiffSegment as $b, ParseErrorsProvider as $c, MetaInfoProps as $d, FeedbackPayload as $f, CommentPostPayload as $g, BetaBadgeProps as $h, isCookielessCompatibleLoginMethod as $i, StringInput as $l, InlinePreview as $m, SearchProvider as $n, removeUndefinedLocaleResources as $o, ConfigPropertyError as $p, useEventsStore as $r, TransformPatches as $s, StudioProviderProps as $t, useFormValue as $u, SourceProviderProps as $v, ProvenanceDiffAnnotation as $w, MutationPayload as $x, OperationsAPI as $y, truncateString as A, NumberInputProps as AC, ValuelessSearchOperatorBuilder as AS, newDraftFrom as AT, IsEqualFunction as A_, isReleaseScheduledOrScheduling as Aa, AnnotationDetails as Ab, FormBuilderProps as Ac, isEmptyObject as Ad, ChangeBreadcrumb as Af, ConnectorContextValue as Ag, DocumentStatus as Ah, ProjectDatasetData as Ai, ObjectInputMember as Al, ToastParams$1 as Am, generateStudioManifest as An, PerspectiveProvider as Ao, RequestFailureDiagnostics as Ap, useResourceCache as Ar, useNumberFormat as As, validateNames as At, useVirtualizerScrollInstance as Au, SourceClientOptions as Av, IncompatibleTypeError as Aw, isUnscheduleDocumentVersionEvent as Ax, DocumentBadgeComponent as Ay, CardinalityOneRelease as B, RenderArrayOfObjectsItemCallback as BC, CookielessCompatibleLoginMethod as BS, RegionWithIntersectionDetails as BT, ActionComponent as B_, useArchivedReleases as Ba, DiffComponentOptions as Bb, ReferenceInputOptions as Bc, emptyValuesByType as Bd, UserColorHue as Bf, StudioCrossDatasetReferenceInputProps as Bg, CommandListGetItemSelectedCallback as Bh, KeyValueStore as Bi, MemberItemProps as Bl, useOnScroll as Bm, DocumentMeta as Bn, defaultLocale as Bo, WorkspacesProviderProps as Bp, TimelineStore as Br, useFilteredReleases as Bs, CorsOriginErrorScreen as Bt, createPatchChannel as Bu, LayoutProps as Bv, PrimitiveItemProps as Bw, LatencyReportEvent as Bx, DocumentActionGroup as By, isReleaseVersion as C, ArrayOfPrimitivesInputProps as CC, PreviewComponent as CE, OperatorInputComponentProps as CS, idMatchesPerspective as CT, ChangeIndicatorTrackerContextValue as C_, ScheduledBadge as Ca, checkoutPair as Cb, ImageInputProps as Cc, EnhancedObjectDialog as Cd, TIMELINE_ITEM_I18N_KEY_MAPPING as Cf, CommentDisabledIcon as Cg, GetHookCollectionState as Ch, useHistoryStore as Ci, prefixPath as Cl, AvatarSkeleton as Cm, getApiErrorCode as Cn, DocumentPreviewPresence as Co, CreateWorkspaceFromConfigOptions as Cp, ActiveWorkspaceMatcherProps as Cr, useSchema as Cs, defaultTemplatesForSchema as Ct, ArrayOfPrimitivesInput as Cu, ReleaseActionsResolver as Cv, FieldsetRenderMembersCallback as Cw, isCreateLiveDocumentEvent as Cx, FormComponents as Cy, useThrottledCallback as D, EditorChange as DC, SearchOperatorInput as DS, isSystemBundle as DT, TrackerContextStore as D_, getDocumentIsInPerspective as Da, CommitRequest as Db, FormProvider as Dc, getItemKey$1 as Dd, ChangeResolverProps as Df, useChangeIndicatorsReporter as Dg, ErrorActions as Dh, useRenderingContextStore as Di, ObjectInputMembers as Dl, ZIndexContextValueKey as Dm, uploadSchema as Dn, usePerspective as Do, prepareConfig as Dp, ResourceCache as Dr, useReconnectingToast as Ds, DEFAULT_STUDIO_CLIENT_OPTIONS as Dt, ArrayOfObjectOptionsInput as Du, SchemaPluginOptions as Dv, ArrayItemError as Dw, isPublishDocumentVersionEvent as Dx, DocumentInspectorProps as Dy, useUnique as E, ComplexElementProps as EC, PreviewProps as EE, SearchOperatorButtonValue as ES, isPublishedId$1 as ET, TrackerContextGetSnapshot as E_, formatRelativeLocalePublishDate as Ea, createBufferedDocument as Eb, StudioFileInput as Ec, findIndex as Ed, ChangeResolver as Ef, useChangeIndicatorsReportedValues as Eg, ErrorWithId as Eh, useProjectStore as Ei, unset as El, LegacyLayerProvider as Em, renderStudio as En, useSetPerspective as Eo, resolveConfig as Ep, useUser as Er, useReferringDocuments as Es, IsLastPaneProvider as Et, ArrayOfOptionsInput as Eu, ScheduledPublishingPluginOptions as Ev, FieldsetState as Ew, isEditDocumentVersionEvent as Ex, DocumentInspectorMenuItem as Ey, joinPath as F, PortableTextInputProps as FC, AuthStore as FS, FormNodePresence as FT, UpsellDialogUpgradeCtaClicked as F_, getReleaseIdFromReleaseDocumentId as Fa, ChangeTitlePath as Fb, defaultRenderInput as Fc, pathToString as Fd, getAnnotationColor as Ff, useNavigateToCanvasDoc as Fg, ContextMenuButton as Fh, SESSION_ID as Fi, MemberFieldProps as Fl, StatusButtonProps as Fm, CopyPasteProvider as Fn, isDocumentLimitError as Fo, RequestErrorReportOptions as Fp, useGlobalPresence as Fr, GlobalCopyPasteElementHandler as Fs, VisibleWorkspacesContextValue as Ft, MutationPatchMsg as Fu, WorkspaceHiddenContext as Fv, UndeclaredMembersError as Fw, editState$1 as Fx, DocumentActionComponent as Fy, measureFirstMatch as G, RenderItemCallback as GC, LocaleDefinition as GS, PresenceLocation as GT, BaseActionDescription as G_, useOnlyHasVersions as Ga, FromToIndex as Gb, TemplatePermissionsResult as Gc, isUnchangedDiff as Gd, UseFeedbackReturn as Gf, CommentCreatePayload as Gg, CollapseMenuButton as Gh, ConnectionStatus as Gi, UrlInput as Gl, RelativeTime as Gm, StudioToolMenu as Gn, useCurrentLocale as Go, PluginFactory as Gp, DocumentValuePermissionsOptions as Gr, DocumentIdStack as Gs, ErrorMessageProps as Gt, FieldActionsResolver as Gu, StudioComponentsPluginOptions as Gv, AssetSourcesResolver as Gw, IdPair as Gx, DuplicateActionProps as Gy, isCardinalityOneRelease as H, RenderBlockCallback as HC, ImplicitLocaleResourceBundle as HS, Size as HT, AssetSourceResolver as H_, RELEASES_INTENT as Ha, DiffProps as Hb, TemplateOption as Hc, isFieldChange as Hd, UserId as Hf, CommentsContextValue as Hg, CommandListItemContext as Hh, CONNECTING as Hi, ArrayOfObjectsInputMembersProps as Hl, RovingFocusNavigationType as Hm, SanityClipboardItem as Hn, UseTranslationOptions as Ho, documentFieldActionsReducer as Hp, GrantsStoreOptions as Hr, useEditState as Hs, WorkspaceLoaderBoundary as Ht, HoveredFieldProvider as Hu, NavbarAction as Hv, ArrayInputInsertEvent as Hw, MutationPerformanceEvent as Hx, DocumentActionModalDialogProps as Hy, _isCustomDocumentTypeDefinition as I, PrimitiveInputElementProps as IC, HandleCallbackResult as IS, Location as IT, UpsellDialogViewed as I_, LATEST as Ia, Chunk as Ib, defaultRenderItem as Ic, pathsAreEqual as Id, getDiffAtPath as If, useCanvasCompanionDoc as Ig, CommandList as Ih, createPresenceStore as Ii, MemberItemError as Il, ScrollContextValue as Im, useCopyPaste as In, useDocumentLimitsUpsellContext as Io, StudioErrorHandler as Ip, useDocumentPresence as Ir, useGlobalCopyPasteElementHandler as Is, VisibleWorkspacesProvider as It, PatchChannel as Iu, WorkspaceHiddenProperty as Iv, BaseItemProps as Iw, DocumentPairLoadedEvent as Ix, DocumentActionConfirmDialogProps as Iy, isRecord as J, BlockAnnotationProps as JC, LocaleResourceBundle as JS, UserSessionPair as JT, Config as J_, useDocumentVersionTypeSortedList as Ja, NullDiff$1 as Jb, useTemplatePermissionsFromHookFactory as Jc, ValueError as Jd, UseInStudioFeedbackReturn as Jf, CommentIntentGetter as Jg, AutoCollapseMenu as Jh, ErrorStatus as Ji, TextInputProps as Jl, useRelativeTime as Jm, SearchDialog as Jn, I18nNode as Jo, createConfig as Jp, DocumentPairPermissionsOptions as Jr, UseDateTimeFormatOptions as Js, useWorkspace as Jt, FieldActionMenuProps as Ju, ReleaseActionDescription as Jv, UploadOptions as Jw, CommitFunction as Jx, isSanityDefinedAction as Jy, isTruthy as K, RenderPreviewCallback as KC, LocaleNestedResource as KS, Session as KT, BetaFeatures as K_, useIsReleaseActive as Ka, GroupChangeNode as Kb, getTemplatePermissions as Kc, noop as Kd, useFeedback as Kf, CommentDocument as Kg, CollapseMenuButtonProps as Kh, ConnectionStatusStore as Ki, UrlInputProps as Kl, RelativeTimeProps as Km, StudioNavbar as Kn, useLocale as Ko, createPlugin as Kp, getDocumentValuePermissions as Kr, useDocumentIdStack as Ks, WorkspaceProvider as Kt, FieldActionsProvider as Ku, ToolMenuProps as Kv, FileLike as Kw, MutationEvent as Kx, DuplicateDocumentActionComponent as Ky, _isSanityDocumentTypeDefinition as L, PrimitiveInputProps as LC, LoginComponentProps as LS, Position as LT, UpsellDialogViewedInfo as L_, PUBLISHED as La, ChunkType as Lb, defaultRenderPreview as Lc, stringToPath as Ld, visitDiff as Lf, StudioReferenceInput as Lg, CommandListElementType as Lh, UserStore as Li, ArrayOfPrimitivesItem as Ll, ScrollEventHandler as Lm, BaseOptions$1 as Ln, Translate as Lo, CorsCheckResult as Lp, createKeyValueStore as Lr, FormattedDuration as Ls, getNamelessWorkspaceIdentifier as Lt, PatchMsg as Lu, WorkspaceOptions as Lv, ItemProps as Lw, DocumentRebaseTelemetryEvent as Lx, DocumentActionCustomDialogComponentProps as Ly, supportsTouch as M, OnPasteFn as MC, defineSearchOperator as MS, systemBundles as MT, ReporterHook as M_, isReleasePerspective as Ma, ArrayItemMetadata as Mb, defaultRenderBlock as Mc, normalizeIndexTupleSegment as Md, useDiffAnnotationColor as Mf, ChangeIndicatorProps as Mg, isReleaseDocument as Mh, ProjectOrganizationData as Mi, MemberFieldSet as Ml, TextWithTone as Mm, StudioManifest as Mn, PerspectiveNotWriteableReason as Mo, createAuthStore as Mp, useProject as Mr, useManageFavorite as Ms, useWorkspaces as Mt, ArrayOfObjectsFunctions as Mu, TemplateResolver as Mv, MissingKeysError as Mw, DocumentVariantType as Mx, DocumentBadgeProps as My, escapeField as N, OnPathFocusPayload as NC, AuthProbeResult as NS, FormFieldGroup as NT, UpsellDialogDismissed as N_, isGoingToUnpublish as Na, BooleanDiff$1 as Nb, defaultRenderField as Nc, normalizeKeySegment as Nd, DiffVisitor as Nf, ChangeFieldWrapper as Ng, MetadataWrapper as Nh, ProjectStore as Ni, MemberFieldError as Nl, TextWithToneProps as Nm, StudioWorkspaceManifest as Nn, isPerspectiveWriteable as No, RequestErrorChannel as Np, createProjectStore as Nr, UseListFormatOptions as Ns, evaluateWorkspaceHidden as Nt, useDidUpdate as Nu, Tool as Nv, MixedArrayError as Nw, getDocumentVariantType as Nx, GetHookCollectionStateProps as Ny, userHasRole as O, InputOnSelectFileFunctionProps as OC, SearchOperatorParams as OS, isSystemBundleName as OT, useTrackerStore as O_, isDraftPerspective as Oa, createObservableBufferedDocument as Ob, FormProviderProps as Oc, getItemKeySegment as Od, ChangeList as Of, ChangeConnectorRoot as Og, ErrorActionsProps as Oh, useUserStore as Oi, ObjectMembers as Ol, ZIndexContextValue as Om, LiveManifestRegisterProvider as On, useGetDefaultPerspective as Oo, AuthStoreOptions as Op, ResourceCacheProvider as Or, useProjectId as Os, ValidateWorkspaceOptions as Ot, VirtualizerScrollInstanceProvider as Ou, SingleWorkspace as Ov, DuplicateKeysError as Ow, isScheduleDocumentVersionEvent as Ox, DocumentInspectorUseMenuItemProps as Oy, fieldNeedsEscape as P, PasteData$1 as PC, AuthState as PS, FieldPresenceData as PT, UpsellDialogLearnMoreCtaClicked as P_, getReleaseTone as Pa, ChangeNode as Pb, defaultRenderInlineBlock as Pc, normalizePathSegment as Pd, getAnnotationAtPath as Pf, getDocumentIdForCanvasLink as Pg, Delay as Ph, PresenceStore as Pi, MemberField as Pl, StatusButton as Pm, StudioFeedbackProvider as Pn, getSelectedVariant as Po, RequestErrorClaim as Pp, getProjectGrants as Pr, useListFormat as Ps, useVisibleWorkspaces as Pt, FormBuilderContextValue as Pu, Workspace as Pv, TypeAnnotationMismatchError as Pw, EditStateFor as Px, HookCollectionActionHook as Py, getTargetDocument as Q, BlockStyleProps as QC, LocaleWeekInfo as QS, DocumentFieldActionHook as QT, DocumentActionsContext as Q_, ReleaseTitle as Qa, StringDiff$1 as Qb, createHookFromObservableFactory as Qc, MetaInfo as Qd, FeedbackContextValue as Qf, CommentPath as Qg, BetaBadge as Qh, isAuthStore as Qi, TagsArrayInputProps as Ql, TemplatePreviewProps as Qm, useSearchState as Qn, defineLocalesResources as Qo, ConfigResolutionErrorOptions as Qp, useDocumentPairPermissionsFromHookFactory as Qr, useClient as Qs, StudioProvider as Qt, FormValueProvider as Qu, SourceProvider as Qv, UploaderResolver as Qw, DocumentRemoteMutationEvent as Qx, OperationImpl as Qy, _isType as R, StringInputProps as RC, AuthConfig as RS, PresentUser as RT, AddonDatasetContextValue as R_, useReleasesIds as Ra, Diff$1 as Rb, EditReferenceLinkComponentProps as Rc, resolveDiffComponent as Rd, HexColor as Rf, StudioReferenceInputProps as Rg, CommandListGetItemDisabledCallback as Rh, UserStoreOptions as Ri, PrimitiveMemberItemProps as Rl, ScrollContainer as Rm, CopyOptions as Rn, TranslateComponentMap as Ro, CorsProbeOutcome as Rp, useTimelineSelector as Rr, UseFormattedDurationOptions as Rs, getWorkspaceIdentifier as Rt, PatchMsgSubscriber as Ru, WorkspaceSummary as Rv, ObjectItem as Rw, DocumentStoreExtraOptions as Rx, DocumentActionDescription as Ry, isPublishedVersion as S, ArrayOfPrimitivesElementType as SC, PortableTextPreviewLayoutKey as SE, OperatorButtonValueComponentProps as SS, getVersionId as ST, PermissionCheckResult as S_, SchedulesContextValue as Sa, WithVersion as Sb, useEnhancedObjectDialog as Sc, FormFieldProps as Sd, DiffCardProps as Sf, CommentsSelectedPathContextValue as Sg, HotkeysProps$1 as Sh, useGrantsStore as Si, insert as Sl, operationEvents as Sm, parseRetryAfter as Sn, FieldPresenceWithOverlay as So, resolveSchemaTypes as Sp, ActiveWorkspaceMatcher as Sr, useStudioUrl as Ss, defaultTemplateForType as St, UniversalArrayInput as Su, PreparedConfig as Sv, FieldSetMember as Sw, isCreateDocumentVersionEvent as Sx, Selection as Sy, readVersionType as T, BooleanInputProps as TC, PreviewMediaDimensions as TE, SearchOperatorBuilder as TS, isDraftId as TT, TrackedChange as T_, EditScheduleForm as Ta, BufferedDocumentWrapper as Tb, FileInputProps as Tc, FIXME as Td, ChangesError as Tf, ChangeIndicatorsTracker as Tg, useCopyErrorDetails as Th, usePresenceStore as Ti, setIfMissing as Tl, UserAvatarProps as Tm, isUnauthorizedError as Tn, useSetVariant as To, createWorkspaceFromConfig as Tp, useCurrentUser as Tr, DocumentField as Ts, useDocumentPreviewValues as Tt, ArrayOfPrimitiveOptionsInput as Tu, SanityFormConfig as Tv, FieldsetMembers as Tw, isDeleteDocumentVersionEvent as Tx, DocumentInspectorComponent as Ty, isPausedCardinalityOneRelease as U, RenderFieldCallback as UC, Locale as US, DocumentPresence as UT, AsyncComposableOption as U_, sortReleases as Ua, FieldChangeNode as Ub, useReferenceInputOptions as Uc, isGroupChange as Ud, useStudioFeedbackTags as Uf, CommentBaseCreatePayload as Ug, CommandListProps as Uh, ConnectedStatus as Ui, ArrayOfObjectsInputMember as Ul, RovingFocusProps as Um, ToolLink as Un, UseTranslationResponse as Uo, defineDocumentFieldAction as Up, createGrantsStore as Ur, useDocumentOperationEvent as Us, useWorkspaceLoader as Ut, useFieldActions as Uu, NavbarProps as Uv, ArrayInputMoveItemEvent as Uw, getPairListener as Ux, DocumentActionPopoverDialogProps as Uy, isCardinalityOnePerspective as V, RenderArrayOfPrimitivesItemCallback as VC, LoginMethod as VS, ReportedRegionWithRect as VT, AppsOptions as V_, useActiveReleases as Va, DiffComponentResolver as Vb, ReferenceInputOptionsProvider as Vc, isAddedItemDiff as Vd, UserColorManager as Vf, CommentsEnabledContextValue as Vg, CommandListHandle as Vh, KeyValueStoreValue as Vi, ArrayOfObjectsInputMembers as Vl, useRovingFocus as Vm, PasteOptions as Vn, usEnglishLocale as Vo, flattenConfig as Vp, useTimelineStore as Vr, useFeatureEnabled as Vs, ConfigErrorGate as Vt, useHoveredField as Vu, LogoProps as Vv, ArrayInputCopyEvent as Vw, ListenerEvent as Vx, DocumentActionKeys as Vy, measureFirstEmission as W, RenderInputCallback as WC, LocaleConfigContext as WS, GlobalPresence as WT, AsyncConfigPropertyReducer as W_, useVersionOperations as Wa, FieldOperationsAPI as Wb, TemplatePermissionsOptions as Wc, isRemovedItemDiff as Wd, FeedbackContext$1 as Wf, CommentContext as Wg, CommandListRenderItemCallback as Wh, ConnectingStatus as Wi, ArrayOfObjectsMemberProps as Wl, Resizable as Wm, ToolLinkProps as Wn, useTranslation$1 as Wo, initialDocumentFieldActions as Wp, grantsPermissionOn as Wr, useDocumentOperation as Ws, ErrorMessage as Wt, FieldActionsProps as Wu, StudioComponents as Wv, UploadEvent as Ww, DocumentPairTarget as Wx, DocumentActionProps as Wy, isArray as X, BlockListItemProps as XC, LocaleResourceRecord as XS, DocumentFieldActionDivider as XT, ConfigPropertyReducer as X_, VersionInlineBadge as Xa, ObjectDiff$1 as Xb, LoadingTuple as Xc, RevertChangesButton as Xd, BaseFeedbackTags as Xf, CommentMessage as Xg, CollapseMenuProps as Xh, createConnectionStatusStore as Xi, TelephoneInputProps as Xl, CircularProgress as Xm, PartialIndexSettings as Xn, defineLocale as Xo, createDefaultIcon as Xp, getDocumentPairPermissions as Xr, useDataset as Xs, UpsellDescriptionSerializer as Xt, useGetFormValue as Xu, ReleaseActionsContext as Xv, Uploader as Xw, DocumentMutationEvent as Xx, Operation as Xy, isNonNullable as Y, BlockDecoratorProps as YC, LocaleResourceKey as YS, DocumentFieldAction as YT, ConfigContext$1 as Y_, useDocumentVersions as Ya, NumberDiff$1 as Yb, PartialExcept as Yc, RevertChangesConfirmDialog as Yd, useInStudioFeedback as Yf, CommentListBreadcrumbs as Yg, CollapseMenu as Yh, RetryingStatus as Yi, TelephoneInput as Yl, LinearProgress as Ym, SearchButton as Yn, useI18nText as Yo, defineConfig as Yp, DocumentPermission as Yr, useDateTimeFormat as Ys, InterpolationProp as Yt, GetFormValueProvider as Yu, ReleaseActionProps as Yv, UploadProgressEvent as Yw, CommittedEvent as Yx, MapDocument as Yy, globalScope as Z, BlockProps as ZC, LocaleSource as ZS, DocumentFieldActionGroup as ZT, DefaultPluginsWorkspaceOptions as Z_, getVersionInlineBadge as Za, ReferenceDiff as Zb, ReactHook as Zc, NoChanges as Zd, DynamicFeedbackTags as Zf, CommentOperations as Zg, CapabilityGate as Zh, onRetry as Zi, TagsArrayInput as Zl, TemplatePreview as Zm, useSearchMaxFieldDepth as Zn, defineLocaleResourceBundle as Zo, ConfigResolutionError as Zp, useDocumentPairPermissions as Zr, useConditionalToast as Zs, useTelemetryConsent as Zt, FormValueContextValue as Zu, Rule$1 as Zv, UploaderDef as Zw, DocumentRebaseEvent as Zx, OperationArgs as Zy, ValidateDocumentOptions as _, NumberFieldProps as _C, FormSetPatch as _E, defineSearchFilterOperators as _S, documentIdEquals as _T, useUserListWithPermissions as __, getSearchableTypes as _a, DocumentVersion as _b, isNumberInputProps as _c, FormFieldSet as _d, FieldPreviewComponent as _f, CommentInput as _g, LoadingBlock as _h, remoteSnapshots as _i, resolveConditionalProperty as _l, InitialValueState as _m, classifyConfigError as _n, PresenceOverlayProps as _o, useFormState as _p, useActiveWorkspace as _r, getPairTarget as _s, Serializeable as _t, DateTimeInputProps as _u, NewDocumentOptionsContext as _v, ArrayOfObjectsMember as _w, PublishDocumentVersionEvent as _x, ObservePathsFn as _y, ReleaseDocument$1 as a, FormBuilderInputComponentMap as aC, DocumentFieldActionsResolverContext as aE, StudioTheme as aS, TargetPerspective as aT, CommentTextSelection as a_, isAgentBundleName as aa, createHistoryStore as ab, useFormBuilder as ac, FormRow as ad, FieldChange as af, useCommentsEnabled as ag, MediaPreviewProps as ah, selectUpstreamVersion as ai, useFormCallbacks as al, DocumentStore as am, StudioAnnouncementsDialog as an, getPreviewPaths as ao, FeedbackDialogProps as ap, Filters as ar, useValidationStatus as as, catchWithCount as at, CreateReferenceOption as au, DocumentInspectorContext as av, ComputeDiff as aw, StudioLocaleResourceKeys as ax, ApiConfig as ay, VersionType as b, StringFieldProps as bC, GeneralDocumentListLayoutKey as bE, I18nSearchOperatorDescriptionKey as bS, getPublishedId$1 as bT, Grant as b_, createSchema as ba, Pair as bb, isStringInputProps as bc, FormFieldHeaderTextProps as bd, DiffErrorBoundaryState as bf, CommentsList as bg, InsufficientPermissionsMessageProps as bh, useDocumentPreviewStore as bi, diffMatchPatch as bl, OperationSuccess as bm, isNetworkError as bn, FieldPresenceInnerProps as bo, useConfigContextFromSource as bp, matchWorkspace as br, SyncState as bs, resolveInitialValue as bt, CrossDatasetReferencePreview as bu, Plugin as bv, DecorationMember as bw, UnscheduleDocumentVersionEvent as bx, Previewable as by, TFunction$1 as c, RenderBlockActionsCallback as cC, FormDiffMatchPatch as cE, Template as cS, CollatedHit as cT, CommentUpdatePayload as c_, usePausedScheduledDraft as ca, TimelineController as cb, deriveDocumentSyncState as cc, FormInputRelativePathArg as cd, DiffTooltip as cf, isTextSelectionComment as cg, DefaultPreview as ch, ErrorState as ci, ParseError as cl, createDocumentStore as cm, Studio as cn, unstable_useObserveDocument as co, DocumentGroupInventoryAction as cp, ColorSchemeProvider as cr, UseUnitFormatterOptions as cs, UserColorManagerOptions as ct, PortableTextMemberItem as cu, DocumentLanguageFilterContext as cv, NodeChronologyProps as cw, CreateLiveDocumentEvent as cx, DocumentAvailability as cy, SANITY_VERSION as d, ArrayFieldProps as dC, FormInsertPatchPosition as dE, TemplateItem as dS, PublishedId as dT, CommentsType as d_, createSearch as da, Timeline as db, connectionState as dc, FormFieldValidationInfo as dd, DiffString as df, CommentsIntentProviderProps as dg, CompactPreviewProps as dh, LoadingState as di, ExpandOperation as dl, listenQuery as dm, RequestErrorDialog as dn, SanityDefaultPreviewProps as do, DocumentGroupInventoryPerspectiveList as dp, useColorSchemeInternalValue as dr, TimeAgoOpts as ds, useUserColorManager as dt, NumberInput as du, DocumentPluginOptions as dv, ObjectArrayFormNode as dw, DocumentGroupEvent as dx, DraftsModelDocumentAvailability as dy, LocalesOption as eC, DocumentFieldActionNode as eE, RemoteSnapshotEvent as eS, PerspectiveContextValue as eT, CommentReactionItem as e_, getProviderTitle as ea, DocumentVersionSnapshots as eb, decodePath as ec, FormDocumentValue as ed, GroupChange as ef, buildTextSelectionFromFragment as eg, InlinePreviewProps as eh, EventsProvider as ei, useParseErrorForPath as el, ConfigPropertyErrorOptions as em, NavbarContextValue as en, ReleaseAvatarIcon as eo, Sentiment as ep, SearchContextValue as er, LocaleProvider as es, getReferencePaths as et, SlugInput as eu, DocumentActionsVersionType as ev, PortableTextPluginsProps as ew, StringSegmentChanged$1 as ex, useSource as ey, getVariantTitle as f, ArrayOfPrimitivesFieldProps as fC, FormPatch as fE, TemplateParameter as fS, SystemBundle as fT, CommentsUIMode as f_, SearchFactoryOptions as fa, TimelineOptions as fb, useConnectionState as fc, FormFieldValidationWarning as fd, DiffStringSegment as ff, CommentsEnabledProvider as fg, PreviewCard as fh, asLoadable as fi, ExpandPathOperation as fl, InitialValueOptions as fm, useRetryCountdown as fn, PreviewLoader as fo, DocumentGroupInventoryReferencePreviewLinkProps as fp, useColorSchemeOptions as fr, useTimeAgo as fs, buildLegacyTheme as ft, AssetAccessPolicy as fu, FormBuilderComponentResolverContext as fv, ObjectFormNode as fw, DocumentVersionEventType as fx, FieldName as fy, isDocumentInSelectedVariant as g, FieldProps as gC, FormSetIfMissingPatch as gE, defineSearchFilter as gS, createPublishedFrom as gT, UserWithPermission as g_, isPerspectiveRaw as ga, CommitError as gb, isBooleanInputProps as gc, FormFieldStatus as gd, DiffFromToProps as gf, CommentInlineHighlightSpan as gg, PopoverDialog as gh, validation$1 as gi, ALL_FIELDS_GROUP as gl, InitialValueMsg as gm, RequestErrorClassification as gn, PresenceOverlay as go, UseFormStateOptions as gp, AddonDatasetProvider as gr, getCreatableVariantTarget as gs, RESOLVE_INITIAL_VALUE_TIMEOUT_MS as gt, DateTimeInput as gu, NewDocumentCreationContext as gv, ArrayOfObjectsItemMember as gw, HistoryClearedEvent as gx, ObserveDocumentTypeFromIdFn as gy, useCreatableVariantInitialValue as h, FieldCommentsProps as hC, FormPatchOrigin as hE, SearchFilterDefinition as hS, createDraftFrom as hT, UserListWithPermissionsOptions as h_, SearchTerms as ha, Transaction as hb, isArrayOfPrimitivesInputProps as hc, FieldStatusProps as hd, DiffFromTo as hf, COMMENTS_INSPECTOR_NAME as hg, usePreviewCard as hh, useDocumentType as hi, setAtPath as hl, InitialValueLoadingMsg as hm, ConfigErrorClassification as hn, PresenceScopeProps as ho, FormState as hp, useAddonDataset as hr, TargetDocumentState as hs, DEFAULT_MAX_RECURSION_DEPTH as ht, getCalendarLabels as hu, MissingConfigFile as hv, StringFormNode as hw, EventsStoreRevision as hx, ObserveDocumentAvailabilityFn as hy, ReconnectEvent as i, FormBuilderFilterFieldFn as iC, DocumentFieldActionsResolver as iE, StudioColorScheme as iS, SelectedPerspective as iT, CommentTaskCreatePayload as i_, useAgentVersionDisplay as ia, HistoryStoreOptions as ib, toMutationPatches as ic, FormCell as id, FromToProps as if, useCommentsSelectedPath as ig, MediaPreview as ih, useInitialValueResolverContext as ii, FormCallbacksValue as il, WithReferringDocuments as im, isValidAnnouncementRole as in, getPreviewValueWithFallback as io, FeedbackDialog as ip, SearchHeader as ir, useVersionRelease as is, EMPTY_OBJECT as it, CreateButton as iu, DocumentCommentsEnabledContext as iv, BooleanFormNode as iw, getValueError as ix, createDocumentPreviewStore as iy, uncaughtErrorHandler as j, ObjectInputProps as jC, ValuelessSearchOperatorParams as jS, removeDupes as jT, Reported as j_, RELEASES_STUDIO_CLIENT_OPTIONS as ja, ArrayDiff$1 as jb, defaultRenderAnnotation as jc, normalizeIndexSegment as jd, useAnnotationColor as jf, ChangeIndicator as jg, VersionInfoDocumentStub as jh, ProjectGrants as ji, ObjectInputMemberProps as jl, TooltipOfDisabled as jm, ManifestWorkspaceInput as jn, ReleasesNav as jo, _createAuthStore as jp, useProjectDatasets as jr, UseManageFavoriteProps as js, validateWorkspaces as jt, ArrayOfObjectsInput as ju, SourceOptions as jv, InvalidItemTypeError as jw, isUpdateLiveDocumentEvent as jx, DocumentBadgeDescription as jy, sliceString as k, InputProps as kC, SearchValueFormatterContext as kS, isVersionId as kT, useTrackerStoreReporter as k_, isPublishedPerspective as ka, Annotation as kb, FormBuilder as kc, getValueAtPath as kd, ChangeListProps as kf, ChangeConnectorRootProps as kg, DocumentStatusIndicator as kh, ProjectData as ki, ObjectMembersProps as kl, ImperativeToast as km, GenerateStudioManifestOptions as kn, useExcludedPerspective as ko, CreateAuthStoreOptions as kp, ResourceCacheProviderProps as kr, UseNumberFormatOptions as ks, validateBasePaths as kt, VirtualizerScrollInstance as ku, Source as kv, FieldError as kw, isUnpublishDocumentEvent as kx, defineDocumentInspector as ky, WelcomeBackEvent as l, RenderBlockActionsProps as lC, FormIncPatch as lE, TemplateArrayFieldDefinition as lS, DRAFTS_FOLDER as lT, CommentsListBreadcrumbItem as l_, SingleDocReleaseProvider as la, TimelineControllerOptions as lb, useDocumentSyncState as lc, FormFieldValidation as ld, DiffTooltipProps as lf, CommentsSelectedPathProvider as lg, DefaultPreviewProps as lh, LoadableState as li, mergeParseErrors as ll, ListenQueryOptions as lm, StudioProps as ln, useUnstableObserveDocument as lo, DocumentGroupInventory as lp, ColorSchemeProviderProps as lr, useUnitFormatter as ls, createUserColorManager as lt, UpdateReadOnlyPlugin as lu, DocumentLanguageFilterResolver as lv, NodeDiffProps as lw, DeleteDocumentGroupEvent as lx, DocumentStackAvailability as ly, useVariantDocumentOperations as m, BooleanFieldProps as mC, FormPatchJSONValue as mE, TypeTarget as mS, collate as mT, UserListWithPermissionsHookValue as m_, SearchSort as ma, DocumentRemoteMutationVersionEvent as mb, isArrayOfObjectsInputProps as mc, FormFieldValidationStatusProps as md, DiffInspectWrapperProps as mf, CommentsAuthoringPathProvider as mg, ReferenceInputPreviewCard as mh, DocumentTypeResolveState as mi, getExpandOperations as ml, InitialValueErrorMsg as mm, passthroughErrorHandler as mn, PresenceScope as mo, useDivergenceNavigator as mp, useColorSchemeValue as mr, CreatableTargetDocument as ms, LegacyThemeTints as mt, EmailInputProps as mu, MediaLibraryConfig as mv, PrimitiveFormNode as mw, EventsStore as mx, InvalidationChannelEvent as my, DEFAULT_DECORATORS as n, ArrayInputFunctionsProps as nC, DocumentFieldActionStatus as nE, StoreRequestErrorHandler as nS, ReleaseId as nT, CommentReactionShortNames as n_, createMockAuthStore as na, DocumentRevision as nb, MutationPatch as nc, useDocumentDivergences as nd, FromToArrowDirection as nf, buildCommentRangeDecorations as ng, BlockImagePreview as nh, useResolveInitialValueForType as ni, useReportParseError as nl, ZIndexProvider as nm, StudioLayoutComponent as nn, Chip as no, StudioFeedbackDialog as np, SearchPopover as nr, ValidationLocaleResourceKeys as ns, formatRelativeLocale as nt, SelectInput as nu, DocumentBadgesContext as nv, ArrayOfPrimitivesFormNode as nw, TypeChangeDiff$1 as nx, DocumentPreviewStoreOptions as ny, ResetEvent as o, FormBuilderMarkersComponent as oC, PatchEvent as oE, StudioThemeColorSchemeKey as oS, SystemVariant as oT, CommentThreadItem as o_, useScheduledDraftsEnabled as oa, removeMissingReferences as ob, useDocumentForm as oc, FormInput as od, FallbackDiff as of, useComments as og, DetailPreview as oh, isNewDocument as oi, createSanityMediaLibraryFileSource as ol, DocumentStoreOptions as om, StudioAnnouncementsContextValue as on, unstable_useValuePreview as oo, isDev as op, ColorSchemeCustomProvider as or, FormattableMeasurementUnit as os, UserColorManagerProvider as ot, getPreviewStateObservable as ou, DocumentInspectorsResolver as ov, DocumentFormNode as ow, BaseEvent as ox, AvailabilityReason as oy, useAllVariants as p, BaseFieldProps as pC, FormPatchBase as pE, TemplateReferenceTarget as pS, VERSION_FOLDER as pT, Loadable as p_, SearchOptions as pa, CombinedDocument as pb, isArrayOfBlocksInputProps as pc, FormFieldValidationStatus as pd, DiffInspectWrapper as pf, CommentsProvider as pg, PreviewCardContextValue as ph, useLoadable as pi, SetActiveGroupOperation as pl, getInitialValueStream as pm, createRequestErrorChannel as pn, Preview as po, DivergenceNavigator as pp, useColorSchemeSetValue as pr, useTemplates as ps, LegacyThemeProps as pt, EmailInput as pu, GroupableActionDescription as pv, ObjectRenderMembersCallback as pw, EditDocumentVersionEvent as px, Id as py, isString as q, RenderPreviewCallbackProps as qC, LocalePluginOptions as qS, Status as qT, ComposableOption as q_, useFormatRelativeLocalePublishDate as qa, ItemDiff$1 as qb, useTemplatePermissions as qc, DocumentChangeContextInstance as qd, SendFeedbackOptions as qf, CommentFieldCreatePayload as qg, CommonProps as qh, ConnectionStatusStoreOptions as qi, TextInput$1 as ql, RelativeTimeOptions as qm, StudioLogo as qn, useGetI18nText as qo, definePlugin as qp, useDocumentValuePermissions as qr, useDialogStack as qs, WorkspaceProviderProps as qt, FieldActionMenu as qu, ReleaseActionComponent as qv, ResolvedUploader as qw, PendingMutationsEvent as qx, SanityDefinedAction as qy, ImageUrlBuilder$1 as r, FormBuilderCustomMarkersComponent as rC, DocumentFieldActionTone as rE, defaultTheme as rS, ReleasesNavMenuItemPropsGetter as rT, CommentStatus as r_, AgentVersionDisplay as ra, HistoryStore as rb, fromMutationPatches as rc, FormContainer as rd, FromTo as rf, useCommentsTelemetry as rg, BlockImagePreviewProps as rh, useInitialValue as ri, FormCallbacksProvider as rl, useZIndex as rm, isValidAnnouncementAudience as rn, prepareForPreview as ro, StudioFeedbackDialogProps as rp, SearchPopoverProps as rr, useWorkspaceSchemaId as rs, EMPTY_ARRAY as rt, ReferenceAutocomplete as ru, DocumentBadgesResolver as rv, BaseFormNode as rw, FieldValueError as rx, ObserveForPreviewFn as ry, SanityClient$1 as s, PortableTextMarker as sC, FormDecPatch as sE, InitialValueTemplateItem as sS, VARIANTS_STUDIO_CLIENT_OPTIONS as sT, CommentUpdateOperationOptions as s_, useScheduledDraftDocument as sa, SelectionState as sb, DocumentSyncState as sc, FormInputAbsolutePathArg as sd, Event$1 as sf, hasCommentMessageValue as sg, DetailPreviewProps as sh, useDocumentValues as si, createSanityMediaLibraryImageSource as sl, QueryParams$1 as sm, StudioAnnouncementsCard as sn, useValuePreview as so, isProd as sp, ColorSchemeLocalStorageProvider as sr, UnitFormatter as ss, UserColorManagerProviderProps as st, PortableTextInput as su, DocumentLanguageFilterComponent as sv, HiddenField as sw, CreateDocumentVersionEvent as sx, AvailabilityResponse as sy, DEFAULT_ANNOTATIONS as t, StaticLocaleResourceBundle as tC, DocumentFieldActionProps as tE, SnapshotEvent as tS, PerspectiveStack as tT, CommentReactionOption as t_, MockAuthStoreOptions as ta, snapshotPair as tb, encodePath as tc, DivergencesProvider as td, FromToArrow as tf, buildRangeDecorationSelectionsFromComments as tg, BlockPreview as th, useEvents as ti, useParseErrors as tl, useMiddlewareComponents as tm, StudioLayout as tn, VersionChip as to, TagValue as tp, SearchResultItemPreview as tr, LocaleProviderBase as ts, getErrorMessage as tt, SlugInputProps as tu, DocumentAskToEditEnabledContext as tv, ArrayOfObjectsFormNode as tw, StringSegmentUnchanged$1 as tx, DocumentPreviewStore as ty, WelcomeEvent as u, RenderCustomMarkers as uC, FormInsertPatch as uE, TemplateFieldDefinition as uS, DraftId as uT, CommentsTextSelectionItem as u_, useSingleDocRelease as ua, ParsedTimeRef as ub, ConnectionState as uc, FormFieldValidationError as ud, DiffTooltipWithAnnotationsProps as uf, CommentsIntentProvider as ug, CompactPreview as uh, LoadedState as ui, ExpandFieldSetOperation as ul, ListenQueryParams as um, useStudioErrorHandler as un, SanityDefaultPreview as uo, DocumentGroupInventoryProps as up, useColorScheme as ur, useTools as us, useUserColor as ut, ObjectInput as uu, DocumentLayoutProps as uv, NumberFormNode as uw, DeleteDocumentVersionEvent as ux, DraftsModelDocument as uy, validateDocument as v, ObjectFieldProps as vC, FormUnsetPatch as vE, SearchOperatorType as vS, getDraftId as vT, DocumentValuePermission as v_, compileFieldPath as va, DocumentVersionEvent as vb, isObjectInputProps as vc, FormFieldSetProps as vd, DiffErrorBoundary as vf, CommentInputHandle as vg, IntentButton as vh, useComlinkStore as vi, SANITY_PATCH_TYPE as vl, InitialValueSuccessMsg as vm, classifyRequestError as vn, FieldPresence as vo, StateTree as vp, MatchWorkspaceOptions as vr, getTargetScopeId as vs, isBuilder as vt, DateInput$1 as vu, NewDocumentOptionsResolver as vv, ArrayOfPrimitivesItemMember as vw, ScheduleDocumentVersionEvent as vx, PreparedSnapshot as vy, isVariantVersion as w, BaseInputProps as wC, PreviewLayoutKey as wE, SearchOperatorBase as wS, isDraft as wT, TrackedArea as w_, useScheduleAction as wa, BufferedDocumentEvent as wb, StudioImageInput as wc, EditPortal as wd, ChangeTitleSegment as wf, CommentDeleteDialog as wg, serializeError as wh, useKeyValueStore as wi, set as wl, UserAvatar as wm, isInvalidSessionError as wn, DocumentPreviewPresenceProps as wo, createSourceFromConfig as wp, RouterHistory as wr, useReviewChanges as ws, prepareTemplates as wt, ArrayOfPrimitivesFunctions as wu, ResolveProductionUrlContext as wv, ObjectMember as ww, isDeleteDocumentGroupEvent as wx, DocumentInspector as wy, isDraftVersion as x, ArrayOfObjectsInputProps as xC, GeneralPreviewLayoutKey as xE, I18nSearchOperatorNameKey as xS, getVersionFromId$1 as xT, GrantsStore as x_, SchedulesContext as xa, RemoteSnapshotVersionEvent as xb, EnhancedObjectDialogContextValue as xc, FormField as xd, DiffCard as xf, CommentsSelectedPath as xg, Hotkeys$1 as xh, useDocumentStore as xi, inc as xl, emitOperation as xm, isTimeoutError as xn, FieldPresenceProps as xo, SchemaError as xp, WorkspacesContextValue as xr, useSyncState as xs, resolveInitialValueForType as xt, BooleanInput as xu, PluginOptions as xv, FieldMember as xw, UpdateLiveDocumentEvent as xx, PreviewableType as xy, ValidationContext$1 as y, PrimitiveFieldProps as yC, PatchArg as yE, operatorDefinitions as yS, getIdPair as yT, EvaluationParams as y_, getSchemaTypeTitle as ya, MutationResult as yb, isObjectItemProps as yc, FormFieldHeaderText as yd, DiffErrorBoundaryProps as yf, CommentInputProps as yg, InsufficientPermissionsMessage as yh, useConnectionStatusStore as yi, dec as yl, OperationError as ym, isClientRequestError as yn, FieldPresenceInner as yo, getConfigContextFromSource as yp, MatchWorkspaceResult as yr, useTargetDocumentState as ys, resolveInitialObjectValue as yt, DateInputProps as yu, PartialContext as yv, ArrayOfPrimitivesMember as yw, UnpublishDocumentEvent as yx, PreviewPath as yy, createSWR as z, RenderAnnotationCallback as zC, AuthProvider as zS, Rect as zT, ActiveWorkspaceMatcherContextValue as z_, useDocumentVersionInfo as za, DiffComponent as zb, EditReferenceOptions as zc, useDocumentChange as zd, UserColor as zf, StudioCrossDatasetReferenceInput as zg, CommandListGetItemKeyCallback as zh, createUserStore as zi, ArrayOfObjectsItem as zl, ScrollContainerProps as zm, CopyPasteContextType as zn, TranslationProps as zo, WorkspacesProvider as zp, TimelineState as zr, useFormattedDuration as zs, WorkspaceLike as zt, RebasePatchMsg as zu, ActiveToolLayoutProps as zv, ObjectItemProps as zw, InitialSnapshotEvent as zx, DocumentActionDialogProps as zy };
//# sourceMappingURL=index-DLGpPgPg.d.ts.map