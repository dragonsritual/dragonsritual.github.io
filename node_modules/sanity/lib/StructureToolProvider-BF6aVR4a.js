...
const structureLocaleNamespace = "structure", structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
	...
	resources: () => import("./resources-DWYbg5ya.js")
});
/** @internal */
...
var ComponentBuilder = class ComponentBuilder {
	...
	*/
	serialize(options = { path: [] }) {
		let { id, title, child, options: componentOptions, component } = this.spec;
...
}, ListItemBuilder = class ListItemBuilder {
	...
	*/
	serialize(options = { path: [] }) {
		...
		let serializeOptions = {
			...
			hint: "child"
		}, listChild = child instanceof ComponentBuilder || child instanceof DocumentListBuilder || child instanceof DocumentBuilder || child instanceof ListBuilder ? child.serialize(serializeOptions) : child;
...
export { MenuItemBuilder as A, FormViewBuilder as C, ComponentBuilder as D, maybeSerializeView as E, SerializeError as F, structureLocaleNamespace as I, structureUsEnglishLocaleBundle as L, getOrderingMenuItemsForSchemaType as M, maybeSerializeMenuItem as N, MenuItemGroupBuilder as O, HELP_URL as P, form as S, GenericViewBuilder as T, menuItemsFromInitialValueTemplateItems as _, isDocumentListItem as a, documentFromEditorWithInitialValue as b, DocumentListBuilder as c, shallowIntentChecker as d, DEFAULT_INTENT_HANDLER as f, maybeSerializeInitialValueTemplateItem as g, defaultInitialValueTemplateItems as h, DocumentListItemBuilder as i, getOrderingMenuItem as j, maybeSerializeMenuItemGroup as k, getTypeNamesFromFilter as l, InitialValueTemplateItemBuilder as m, createStructureBuilder as n, ListItemBuilder as o, defaultIntentChecker as p, DocumentTypeListBuilder as r, ListBuilder as s, StructureToolProvider as t, GenericListBuilder as u, DocumentBuilder as v, ComponentViewBuilder as w, component as x, documentFromEditor as y };

//# sourceMappingURL=StructureToolProvider-BF6aVR4a.js.map