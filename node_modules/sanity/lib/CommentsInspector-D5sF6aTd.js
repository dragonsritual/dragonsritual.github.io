...
import { b as commentsLocaleNamespace, f as isTextSelectionComment, t as useComments, y as useCommentsScroll } from "./useComments-D_nSQUGP.js";
...
import { Box, Card, Container, Flex, Layer, Menu, Stack, Text, useClickOutsideEvent, useLayer, useToast } from "@sanity/ui";
...
const Root$1 = styled(Box).withConfig({
	displayName: "Root",
	componentId: "sc-9t047v-0"
})`max-width:280px;`, fadeInKeyFrame = keyframes`from{opacity:0;}to{opacity:1;}`, StyledPopover = styled(Popover$1).withConfig({
...
function CommentsOnboardingPopover(props) {
	...
	let t5;
	$[13] !== onDismiss || $[14] !== t4 ? (t5 = /* @__PURE__ */ jsx(Flex, {
		justify: "flex-end",
		marginTop: 2,
...
function CommentsInspectorError(t0) {
	...
	let t4;
	return $[6] !== t2 || $[7] !== t3 ? (t4 = /* @__PURE__ */ jsx(Box, {
		padding: 2,
...
function CommentsInspectorHeader(props) {
	...
	let t3;
	$[6] === t2 ? t3 = $[7] : (t3 = /* @__PURE__ */ jsx(Flex, {
		align: "center",
		flex: 1,
		gap: 2,
		paddingY: 2,
	...
	let t22;
	$[48] !== t17 || $[49] !== t21 ? (t22 = /* @__PURE__ */ jsxs(Flex, {
		flex: "none",
		padding: 1,
		gap: 2,
		children: [t17, t21]
	...
	let t23;
	$[51] !== t22 || $[52] !== t3 ? (t23 = /* @__PURE__ */ jsxs(Flex, {
		padding: 2,
		children: [t3, t22]
...
function CommentsInspectorInner(props) {
	...
	let t30;
	$[114] !== handleDeselectPath || $[115] !== t27 || $[116] !== t28 || $[117] !== t29 ? (t30 = /* @__PURE__ */ jsxs(Flex, {
		direction: "column",
		flex: 1,
		height: "fill",
...
//# sourceMappingURL=CommentsInspector-D5sF6aTd.js.map