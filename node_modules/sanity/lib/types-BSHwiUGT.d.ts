...
import { ConfigContext, DocumentActionComponent, DocumentBadgeComponent, DocumentFieldAction, DocumentFieldActionNode, DocumentFormNode, DocumentInspector, DocumentLanguageFilterComponent, DocumentStore, DocumentSyncState, EditStateFor, GeneralPreviewLayoutKey, I18nTextRecord, InitialValueTemplateItem, LocaleSource, NodeChronologyProps, PatchEvent, PermissionCheckResult, PerspectiveStack, PreviewLayoutKey, ReleaseId, Source, StateTree, TargetDocumentState, TimelineStore } from "sanity";
import { SearchParam } from "sanity/router";
import { ObjectSchemaType, Path, SanityDocument as SanityDocument$1, SanityDocumentLike, SchemaType, SortOrdering, SortOrderingItem, ValidationMarker } from "@sanity/types";
/**
...
type UserViewComponent<TOptions = Record<string, any>> = React.ComponentType<{
  document: {
    draft: SanityDocument$1 | null;
    displayed: Partial<SanityDocument$1>;
    historical: Partial<SanityDocument$1> | null;
    published: SanityDocument$1 | null;
  };
  documentId: string;
  options: TOptions;
  schemaType: SchemaType;
...
interface DocumentPaneContextValue extends Pick<NodeChronologyProps, 'hasUpstreamVersion'> {
  ...
  compareValue: SanityDocument$1 | null;
  ...
  displayed: Partial<SanityDocument$1> | null;
  ...
  lastRevisionDocument: SanityDocument$1 | null;
}
/** @internal */
...
export { defaultIntentChecker as $, MenuItemActionType as $t, StructureToolFeatures as A, UnserializedListItemChild as At, UserComponent as B, GenericListBuilder as Bt, RouterPaneSiblingContext as C, ItemChild as Cn, ListItemBuilder as Ct, StructureResolver as D, ListItemSerializeOptions as Dt, StrictVersionLayeringOptions$1 as E, ListItemInput as Et, PaneLayoutContextValue as F, PartialDocumentList as Ft, ComponentBuilder as G, MenuItemGroupBuilder as Gt, View as H, ListDisplayOptions as Ht, DefaultDocumentNodeContext as I, getTypeNamesFromFilter as It, DEFAULT_INTENT_HANDLER as J, defaultInitialValueTemplateItems as Jt, ComponentInput as K, maybeSerializeMenuItemGroup as Kt, DefaultDocumentNodeResolver as L, BaseGenericList as Lt, StructureToolPaneActionHandler as M, DocumentListBuilder as Mt, UnresolvedPaneNode as N, DocumentListInput as Nt, StructureResolverContext as O, PartialListItem as Ot, PaneContextValue as P, DocumentListOptions as Pt, IntentParams as Q, MenuItem as Qt, StructureBuilder as R, BuildableGenericList as Rt, RouterPaneSibling as S, ChildResolverOptions as Sn, ListItem as St, SerializablePaneNode as T, ListItemDisplayOptions as Tt, BuildableComponent as U, shallowIntentChecker as Ut, UserViewComponent as V, GenericListInput as Vt, Component$1 as W, MenuItemGroup as Wt, IntentChecker as X, menuItemsFromInitialValueTemplateItems as Xt, Intent as Y, maybeSerializeInitialValueTemplateItem as Yt, IntentJsonParams as Z, KnownMenuItemParams as Zt, PaneMenuItem as _, FormViewBuilder as _n, DocumentListItem as _t, ParameterizedLinkProps as a, getOrderingMenuItemsForSchemaType as an, DocumentNode as at, PaneNodeResolver as b, ChildObservable as bn, PartialDocumentListItem as bt, DocumentPaneInfoContextValue as c, DocumentOptions as cn, SerializeOptions as ct, DocumentFieldMenuActionNode as d, documentFromEditorWithInitialValue as dn, BuildableList as dt, MenuItemBuilder as en, Builder as et, DocumentListPaneNode as f, BaseView as fn, List as ft, PaneListItemDivider as g, FormView as gn, DocumentTypeListInput as gt, PaneListItem as h, maybeSerializeView as hn, DocumentTypeListBuilder as ht, PaneRouterContextValue as i, getOrderingMenuItem as in, Divider as it, StructureToolOptions as j, DocumentList as jt, StructureToolContextValue as k, UnserializedListItem as kt, BaseResolvedPaneNode as l, PartialDocumentNode as ln, SerializePath as lt, ListPaneNode as m, ViewBuilder as mn, ListInput as mt, ChildLinkProps as n, PartialMenuItem as nn, Collection as nt, ReferenceChildLinkProps as o, maybeSerializeMenuItem as on, EditorNode as ot, DocumentPaneNode as p, GenericViewBuilder as pn, ListBuilder as pt, BaseIntentParams as q, InitialValueTemplateItemBuilder as qt, EditReferenceOptions as r, SortMenuItem as rn, CollectionBuilder as rt, DocumentPaneContextValue as s, DocumentBuilder as sn, Serializable as st, BackLinkProps as t, MenuItemParamsType as tn, Child as tt, CustomComponentPaneNode as u, documentFromEditor as un, StructureNode as ut, PaneMenuItemGroup as v, ComponentView as vn, DocumentListItemBuilder as vt, RouterPanes as w, ListItemChild as wt, RouterPaneGroup as x, ChildResolver as xn, isDocumentListItem as xt, PaneNode as y, ComponentViewBuilder as yn, DocumentListItemInput as yt, StructureContext as z, GenericList as zt };
//# sourceMappingURL=types-BSHwiUGT.d.ts.map