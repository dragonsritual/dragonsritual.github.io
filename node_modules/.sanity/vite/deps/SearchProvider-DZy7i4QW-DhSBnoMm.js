...
import { Dt as SearchContext, r as AppIdCacheContext } from "./_singletons-Bw6wdunb.js";
import { t as require_compiler_runtime } from "./compiler-runtime-C3z9ieX8.js";
import { $ as Text, Dt as ft, F as Card, H as Menu, I as Flex, N as Box, Ot as gt, P as Button, Tt as Et, U as MenuDivider, X as Stack, a as Badge, ct as studioTheme, et as TextInput, ft as useGlobalKeyDown, l as Code, mt as useMediaIndex, ot as rem, pt as useLayer, q as Portal, u as Container, ut as useClickOutsideEvent, z as Inline } from "./dist-D-cKgnXq.js";
import { t as SpinnerIcon } from "./Spinner-CeBGrM7j.js";
...
import { l as noop, n as Subject, r as Observable } from "./BehaviorSubject-CtPYBbcz.js";
import { i as createOperatorSubscriber, o as operate, t as map } from "./map-DAZpcdQM.js";
import { Jt as useDocumentPreviewStore, Mi as switchMap, Pi as scan, Qt as useKeyValueStore, Ur as omit, Xt as useGrantsStore, Zi as merge, en as useProjectStore, mt as isRecord$4, ni as uniq, or as startCase, qt as useCurrentUser, rn as useSchema, tn as useRenderingContextStore, zi as distinctUntilChanged } from "./datastores-BncX_uvZ-Cz4txWdG.js";
import { A as innerFrom, E as of, N as popResultSelector, b as concat, d as useWorkspace, i as useSyncObservable, l as useClient, m as startWith, n as useObservableEvent, o as DEFAULT_STUDIO_CLIENT_OPTIONS, p as tap, t as useObservable, u as useSource, v as catchError, y as timer } from "./dist-a7ePbwyj.js";
import { C as mapOneOrManyArgs, S as argsArgArrayOrObject, T as EMPTY, g as useTelemetry, p as defineEvent, x as createObject } from "./dist-CCMvtkH6.js";
import { t as filter } from "./filter-CVvmgpYw.js";
import { Ls as es2015_default, Qo as useSearchMaxFieldDepth, Ra as supportsTouch, Wa as useActiveReleases, Xr as getDocumentVersionInfoFromVersions, _o as useDocumentPresence, ct as DocumentStatus, ii as getPreviewStateObservable, jn as SanityDefaultPreview, lt as DocumentStatusIndicator, nc as iif, ss as useValuePreview, st as DocumentPreviewPresence, ut as EMPTY_ARRAY$12, vr as createSearch, yn as PreviewCard$1, yo as useDocumentVersions, za as truncateString } from "./useBundleDocuments-DpiMoPsr-CYBYABmS.js";
...
import { i as Popover$1 } from "./ConfirmPopover-CD1rDyuk-BprYXu6g.js";
import { l as isNonNullable, p as removeDupes, v as getPublishedId } from "./draftUtils-D3HJGQaW-CpQZ8djC.js";
import { t as WarningOutlineIcon } from "./WarningOutline-CT08yzBL.js";
import { L as isObjectSchemaType } from "./lib-BsvRcu2m.js";
import { _ as isBuffer, c as baseKeys, f as isTypedArray, n as _getTag_default, s as isArrayLike, u as isPrototype, v as isArguments, w as isArray } from "./_baseIsEqual-B6KAWdgP.js";
import { t as isEqual } from "./isEqual-DUlN4Vfe.js";
import { i as difference, r as require_browser, t as partition } from "./partition-BKS1U6Z3.js";
import { t as Translate } from "./Translate-B8ORyU6k-DCjWWnpI.js";
import { n as TextWithTone } from "./ContextMenuButton-CruB3rT2-DM9Tu9Z0.js";
import { t as UnknownIcon } from "./Unknown-CimHLv5A.js";
import { m as intersection, u as useIntentLink } from "./router-r2bwUxf-.js";
...
import { t as CommandList } from "./CommandList-B7noXKqO-BISj7arG.js";
import { t as SortIcon } from "./Sort-B-uLsYQq.js";
import { t as ControlsIcon } from "./Controls-BHfjJ7v_.js";
...
//#endregion
//#region node_modules/sanity/lib/SearchProvider-DZy7i4QW.js
...
var SearchResultItemPreviewBox = gt(Box).withConfig({
	...
	componentId: "sc-8lsq3v-0"
})`@supports (-webkit-overflow-scrolling:touch){* [data-ui='Box']{background-attachment:scroll;}}`;
/**
* @internal
*/
function SearchResultItemPreview(t0) {
	let $ = (0, import_compiler_runtime.c)(41), { documentId, documentType, layout, presence, schemaType, showBadge: t1, perspective, variant } = t0, showBadge = t1 === void 0 || t1, documentPreviewStore = useDocumentPreviewStore(), t2;
	...
	$[11] === versions ? t5 = $[12] : (t5 = getDocumentVersionInfoFromVersions(versions), $[11] = versions, $[12] = t5);
	let versionsInfo = t5, t6;
	bb0: {
		if (isLoading) {
			t6 = null;
			break bb0;
		...
		let t7;
		$[13] === presence ? t7 = $[14] : (t7 = presence && presence.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocumentPreviewPresence, { presence }), $[13] = presence, $[14] = t7);
		let t8;
		$[15] !== schemaType.title || $[16] !== showBadge ? (t8 = showBadge && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, { children: schemaType.title }), $[15] = schemaType.title, $[16] = showBadge, $[17] = t8) : t8 = $[17];
		let t9;
		$[18] !== versionsInfo.draft || $[19] !== versionsInfo.published || $[20] !== versionsInfo.versions ? (t9 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocumentStatusIndicator, {
			draft: versionsInfo.draft,
			published: versionsInfo.published,
			versions: versionsInfo.versions
		}), $[18] = versionsInfo.draft, $[19] = versionsInfo.published, $[20] = versionsInfo.versions, $[21] = t9) : t9 = $[21];
		let t10;
		$[22] !== t7 || $[23] !== t8 || $[24] !== t9 ? (t10 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
			align: "center",
			gap: 3,
			children: [
				t7,
		...
		}), $[22] = t7, $[23] = t8, $[24] = t9, $[25] = t10) : t10 = $[25], t6 = t10;
	}
	let status = t6, t7;
	$[26] !== versionsInfo.draft || $[27] !== versionsInfo.published || $[28] !== versionsInfo.versions ? (t7 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocumentStatus, {
		draft: versionsInfo.draft,
		published: versionsInfo.published,
		versions: versionsInfo.versions
	}), $[26] = versionsInfo.draft, $[27] = versionsInfo.published, $[28] = versionsInfo.versions, $[29] = t7) : t7 = $[29];
	let tooltip = t7, t8;
	$[30] !== documentStub || $[31] !== original || $[32] !== snapshot ? (t8 = getPreviewValueWithFallback({
		snapshot,
		original,
		fallback: documentStub
	}), $[30] = documentStub, $[31] = original, $[32] = snapshot, $[33] = t8) : t8 = $[33];
	let t9 = isLoading ?? !0, t10 = layout || "default", t11;
	return $[34] !== schemaType.icon || $[35] !== status || $[36] !== t10 || $[37] !== t8 || $[38] !== t9 || $[39] !== tooltip ? (t11 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchResultItemPreviewBox, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SanityDefaultPreview, {
		...t8,
		isPlaceholder: t9,
		layout: t10,
		...
		status,
		tooltip
	}) }), $[34] = schemaType.icon, $[35] = status, $[36] = t10, $[37] = t8, $[38] = t9, $[39] = tooltip, $[40] = t11) : t11 = $[40], t11;
}
...
function useSearch(t0) {
	let $ = (0, import_compiler_runtime.c)(16), { allowEmptyQueries, initialState, onComplete, onError, onStart, schema } = t0, [searchState, setSearchState] = (0, import_react.useState)(initialState), client = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), maxFieldDepth = useSearchMaxFieldDepth(), { strategy } = useWorkspace().search, t1;
	...
	let search = t1, t2;
	$[5] !== allowEmptyQueries || $[6] !== onComplete || $[7] !== onError || $[8] !== onStart || $[9] !== search ? (t2 = (inputValue$) => inputValue$.pipe(filter(nonNullable), map(sanitizeRequest), distinctUntilChanged(isEqual), debounce(_temp$7), tap(onStart), switchMap((request_0) => concat(of({
		...
		allowEmptyQueries,
		terms: request_0.terms
	}), search(request_0.terms, request_0.options).pipe(tap((t3) => {
		let { hits, nextCursor } = t3;
		return onComplete?.({
			hits,
			nextCursor
		});
	}), catchError((error) => (onError?.(error), of({
		...INITIAL_SEARCH_STATE,
		error,
		loading: !1,
		options: request_0.options,
		...
		hits: [],
		nextCursor: void 0
	})))), of({ loading: !1 }))), scan(_temp2$2, INITIAL_SEARCH_STATE), tap(setSearchState)), $[5] = allowEmptyQueries, $[6] = onComplete, $[7] = onError, $[8] = onStart, $[9] = search, $[10] = t2) : t2 = $[10];
...
function narrowDocumentTypes({ fieldDefinitions, filters, types }) {
	let selectedDocumentTypes = types.map((type) => type.name), intersectingDocumentTypes = intersection(...Object.values(fieldDefinitions).filter((field) => filters.map((filter) => filter?.fieldId).includes(field.id)).filter((field) => field.documentTypes.length > 0).map((field) => field.documentTypes)), documentTypes = [];
...
function FilterTooltip(t0) {
	...
	if ($[0] !== documentTypesNarrowed.length || $[1] !== fieldDefinition || $[2] !== filterDefinition || $[3] !== schema || $[4] !== t) {
		...
		}).filter(isNonNullable).sort() : EMPTY_ARRAY$12;
			...
			if (fieldDefinition?.documentTypes) {
				...
				if ($[28] !== fieldDefinition.documentTypes || $[29] !== fieldDefinition.fieldPath || $[30] !== schema) {
					...
					$[32] !== fieldDefinition.fieldPath || $[33] !== schema ? (t11 = (d_0) => {
						...
						return null;
					}, $[32] = fieldDefinition.fieldPath, $[33] = schema, $[34] = t11) : t11 = $[34], t10 = uniq(fieldDefinition.documentTypes.map(t11).filter(isNonNullable).sort()), $[28] = fieldDefinition.documentTypes, $[29] = fieldDefinition.fieldPath, $[30] = schema, $[31] = t10;
				} else t10 = $[31];
...
var CustomBox = gt(Box).withConfig({
	...
	componentId: "sc-yldci7-0"
})`flex-shrink:${({ $flexShrink = 0 }) => $flexShrink};`;
function FilterLabel(t0) {
	let $ = (0, import_compiler_runtime.c)(29), { filter, fontSize: t1, showContent: t2 } = t0, fontSize = t1 === void 0 ? 1 : t1, showContent = t2 === void 0 || t2, { t } = useTranslation$1(), { state: t3 } = useSearchState(), { definitions, fullscreen } = t3, t4;
	...
	$[3] !== filter || $[4] !== fontSize || $[5] !== fullscreen ? (t5 = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CustomBox, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWithTone, {
			...
			textOverflow: "ellipsis",
			weight: "medium",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterTitle, {
				filter,
	...
	$[7] !== fontSize || $[8] !== showContent ? (t6 = (t7) => {
		let { children } = t7;
		return showContent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CustomBox, {
			$flexShrink: 0,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWithTone, {
				tone: "default",
				size: fontSize,
	...
	$[10] !== ButtonValue || $[11] !== filterValue || $[12] !== fontSize || $[13] !== showContent ? (t7 = (t8) => {
		...
		return showContent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CustomBox, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextWithTone, {
				...
				textOverflow: "ellipsis",
				weight: "medium",
				children: ButtonValue ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ButtonValue, { value: filterValue }) : children_0
			})
		}) : null;
	...
	if (operator?.descriptionKey || console.warn("Missing `descriptionKey` for operator `%s`", filter.operatorType), !showContent || !operator?.descriptionKey) {
		...
		return $[19] === Field ? t9 = $[20] : (t9 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flex, {
			align: "center",
			gap: 1,
	...
	let t11;
	return $[24] !== components || $[25] !== t || $[26] !== t10 || $[27] !== t9 ? (t11 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flex, {
		align: "center",
		gap: 1,
...
function getFilterValues(filter, t) {
	let values = {};
	return typeof filter.value == "number" && (values.count = filter.value), isStringOrNumber(filter.value) && (values.value = filter.value), typeof filter.value == "boolean" && (values.value = filter.value ? t("search.filter-boolean-true") : t("search.filter-boolean-false")), isRecord$4(filter.value) && "from" in filter.value && isStringOrNumber(filter.value.from) && (values.from = filter.value.from), isRecord$4(filter.value) && "to" in filter.value && isStringOrNumber(filter.value.to) && (values.to = filter.value.to), values;
}
...
function useStoredSearch() {
	...
	}), map(_temp$5)), optimisticWrites$).pipe(startWith(defaultValue)), $[3] = keyValueStore, $[4] = keyValueStoreKey, $[5] = t2) : t2 = $[5];
...
function _temp$3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ControlsIcon, { style: { padding: "0 0.25rem" } }, 0);
}
...
function SortMenu() {
	let $ = (0, import_compiler_runtime.c)(48), { t } = useTranslation$1(), { strategy: searchStrategy } = useWorkspace().search, { state: t0 } = useSearchState(), { ordering } = t0, menuButtonId = (0, import_react.useId)(), t1;
	...
	let t13;
	$[25] !== T0 || $[26] !== t5 || $[27] !== t6 || $[28] !== t7 ? (t13 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T0, {
		mode: t5,
		icon: t6,
		text: t7
	}), $[25] = T0, $[26] = t5, $[27] = t6, $[28] = t7, $[29] = t13) : t13 = $[29];
	let t14 = menuButtonId || "", t15;
	$[30] === menuOrderings ? t15 = $[31] : (t15 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { children: menuOrderings.map(_temp$1) }), $[30] = menuOrderings, $[31] = t15);
	let t16;
	...
	let t17;
	$[33] !== T1 || $[34] !== t13 || $[35] !== t14 || $[36] !== t15 ? (t17 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T1, {
		button: t13,
		id: t14,
		menu: t15,
		popover: t16
	...
	let t18;
	$[38] !== T2 || $[39] !== t10 || $[40] !== t17 || $[41] !== t8 || $[42] !== t9 ? (t18 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T2, {
		align: t8,
		flex: t9,
		padding: t10,
		children: t17
	...
	let t19;
	return $[44] !== T3 || $[45] !== t11 || $[46] !== t18 ? (t19 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T3, {
		borderBottom: t11,
		children: t18
...
//#endregion
export { isHotkey as A, isStaging as C, useSearchState as D, useSearch as E, forkJoin as M, useStudioAppIdStore as O, hasSearchableTerms as S, useRenderingContext as T, getPreviewValueWithFallback as _, RecentSearches as a, getSearchableTypes as b, SearchProvider as c, SearchResults as d, SearchWrapper as f, getDocumentTypesTruncated as g, defineSearchFilterOperators as h, GLOBAL_SEARCH_KEY_MODIFIER as i, debounce as j, require_server_browser as k, SearchResultItem as l, defineSearchFilter as m, CustomTextInput as n, SearchHeader as o, StatusButton as p, Filters as r, SearchPopover as s, AppIdCacheProvider as t, SearchResultItemPreview as u, getSanityImportMapUrl as v, useProjectOrganizationId as w, hasSanityPackageInImportMap as x, getSchemaField as y };
