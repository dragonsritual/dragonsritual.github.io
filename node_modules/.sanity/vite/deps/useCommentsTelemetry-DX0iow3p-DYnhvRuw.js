...
import { $ as Text, Dt as ft, I as Flex, N as Box, Ot as gt, P as Button, X as Stack, o as BoundaryElementProvider, u as Container } from "./dist-D-cKgnXq.js";
...
import { a as CommentInput, d as applyCommentsGroupAttr, g as hasCommentMessageValue, m as commentsLocaleNamespace } from "./useComments-D_nSQUGP-cp0GsTx0.js";
import { n as CommentsListItem, r as ThreadCard } from "./CommentsListItem-C1qIKAOP-DgbvpkQT.js";
//#region node_modules/sanity/lib/useCommentsTelemetry-DX0iow3p.js
...
var HeaderFlex = gt(Flex).withConfig({
	...
	componentId: "sc-gosei9-0"
})`min-height:25px;`;
var BreadcrumbsButton = /* @__PURE__ */ gt(Button).withConfig({
	displayName: "BreadcrumbsButton",
	componentId: "sc-gosei9-1"
})(({ theme }) => ft`--card-fg-color:${theme.sanity.color.base.fg};max-width:100%;`);
