...
import { $ as Spinner, A as Arrow, At as parseColor, B as useMediaIndex, C as textInputRepresentationStyle, Ct as isHTMLTextAreaElement, D as useCustomValidity, Dt as hexToRgb, E as responsiveInputPaddingStyle, Et as createColorTheme, F as useBoundaryElement, Ft as studioTheme, G as ThemeColorProvider, H as _elementSizeObserver, I as BoundaryElementContext, J as createGlobalScopedContext, K as useRootTheme, L as isRecord, M as usePortal, Mt as rgbToHsl, N as useLayer, Nt as rgba, O as Stack, Ot as hslToRgb, P as LayerProvider, Pt as screen, Q as _cardColorStyle, R as usePrefersReducedMotion, S as textInputFontSizeStyle, St as isHTMLSelectElement, T as responsiveInputPaddingIconRightStyle, Tt as EMPTY_RECORD, U as _ResizeObserver, V as useElementSize, W as Card, X as focusRingBorderStyle, Y as Button, Z as focusRingStyle, _ as Layer, _t as containsOrEqualsElement, a as useDelayedState, at as Flex, b as TextInput, bt as isHTMLElement, c as TabList, ct as responsiveRadiusStyle, d as MenuGroup, dt as _fillCSSObject, et as Text, f as MenuDivider, ft as _getArrayProp, g as Inline, gt as _isEnterToClickElement, h as KBD, ht as rem, i as TooltipDelayGroupContext, it as responsiveTextAlignStyle, j as Portal, jt as rgbToHex, k as Popover, kt as multiply, l as Tab, lt as Box, m as Hotkeys, mt as _responsive, n as Tooltip, nt as responsiveTextFont, o as usePrefersDark, ot as useTheme, p as Menu, pt as _getResponsiveSpace, q as ThemeProvider, r as useTooltipDelayGroup, rt as responsiveFont, s as Grid, st as useTheme_v2, t as PortalProvider, tt as SpanWithTextOverflow, u as MenuItem, ut as responsivePaddingStyle, v as useGlobalKeyDown, vt as isHTMLAnchorElement, w as textInputRootStyle, wt as EMPTY_ARRAY, x as textInputBaseStyle, xt as isHTMLInputElement, y as useClickOutsideEvent, yt as isHTMLButtonElement, z as useMatchMedia } from "./_chunks/portalProvider.js";
...
function TreeItem(props) {
	let $ = c(117), IconComponent, children, gap, href, idProp, linkAs, linkProps, muted, onClick, restProps, t0, t1, t2, t3, t4, text, weight;
	...
	$[40] !== expanded || $[41] !== itemKey || $[42] !== registerItem || $[43] !== rootElement || $[44] !== selected ? (t13 = () => {
		...
		rootElement,
		selected
	], $[40] = expanded, $[41] = itemKey, $[42] = registerItem, $[43] = rootElement, $[44] = selected, $[45] = t13, $[46] = t14) : (t13 = $[45], t14 = $[46]), useEffect(t13, t14);
	...
	let t17;
	$[49] !== IconComponent || $[50] !== fontSize || $[51] !== muted || $[52] !== weight ? (t17 = IconComponent && /* @__PURE__ */ jsx(Text, {
		muted,
		size: fontSize,
		weight,
	...
	let t18;
	$[54] !== IconComponent || $[55] !== expanded || $[56] !== fontSize || $[57] !== muted || $[58] !== weight ? (t18 = !IconComponent && /* @__PURE__ */ jsx(ToggleArrowText, {
		muted,
		size: fontSize,
		weight,
	...
	let t19;
	$[60] !== spacing || $[61] !== t16 || $[62] !== t17 || $[63] !== t18 ? (t19 = /* @__PURE__ */ jsxs(Box, {
		marginRight: spacing,
		style: t16,
		children: [t17, t18]
	}), $[60] = spacing, $[61] = t16, $[62] = t17, $[63] = t18, $[64] = t19) : t19 = $[64];
	let t20;
	$[65] !== fontSize || $[66] !== muted || $[67] !== text || $[68] !== weight ? (t20 = /* @__PURE__ */ jsx(Box, {
		flex: 1,
		children: /* @__PURE__ */ jsx(Text, {
			muted,
			size: fontSize,
	...
	let t21;
	$[70] !== padding || $[71] !== t19 || $[72] !== t20 ? (t21 = /* @__PURE__ */ jsxs(Flex, {
		padding,
		children: [t19, t20]
	...
	if (href) {
		...
		$[74] !== content || $[75] !== expanded || $[76] !== href || $[77] !== linkAs || $[78] !== linkProps || $[79] !== t23 || $[80] !== tabIndex || $[81] !== tree.level ? (t24 = /* @__PURE__ */ jsx(TreeItemBox, {
			...linkProps,
			$level: tree.level,
			"aria-expanded": expanded,
			as: linkAs,
		...
		let t25;
		$[83] !== children || $[84] !== expanded ? (t25 = children && /* @__PURE__ */ jsx(TreeGroup, {
			hidden: !expanded,
			children
		}), $[83] = children, $[84] = expanded, $[85] = t25) : t25 = $[85];
		let t26;
		$[86] !== contextValue || $[87] !== t25 ? (t26 = /* @__PURE__ */ jsx(TreeContext.Provider, {
			value: contextValue,
			children: t25
		}), $[86] = contextValue, $[87] = t25, $[88] = t26) : t26 = $[88];
		let t27;
		return $[89] !== handleClick || $[90] !== id || $[91] !== itemKey || $[92] !== restProps || $[93] !== t22 || $[94] !== t24 || $[95] !== t26 ? (t27 = /* @__PURE__ */ jsxs(StyledTreeItem, {
			"data-selected": t22,
			"data-tree-id": id,
	...
	$[97] !== content || $[98] !== tree.level ? (t23 = /* @__PURE__ */ jsx(TreeItemBox, {
		$level: tree.level,
		as: "div",
		"data-ui": "TreeItem__box",
		children: content
	...
	let t24;
	$[100] !== children || $[101] !== expanded ? (t24 = children && /* @__PURE__ */ jsx(TreeGroup, {
		expanded,
		children
	}), $[100] = children, $[101] = expanded, $[102] = t24) : t24 = $[102];
	let t25;
	$[103] !== contextValue || $[104] !== t24 ? (t25 = /* @__PURE__ */ jsx(TreeContext.Provider, {
		value: contextValue,
		children: t24
	}), $[103] = contextValue, $[104] = t24, $[105] = t25) : t25 = $[105];
	let t26;
	return $[106] !== expanded || $[107] !== handleClick || $[108] !== handleKeyDown || $[109] !== id || $[110] !== itemKey || $[111] !== restProps || $[112] !== t22 || $[113] !== t23 || $[114] !== t25 || $[115] !== tabIndex ? (t26 = /* @__PURE__ */ jsxs(StyledTreeItem, {
		"data-selected": t22,
		"data-ui": "TreeItem",
		"data-tree-id": id,
		"data-tree-key": itemKey,
...
const StyledSrOnly = styled.div.withConfig({
	...
	let t14;
	$[37] !== children || $[38] !== t13 ? (t14 = /* @__PURE__ */ jsx("div", {
		ref: wrapperRef,
		style: t13,
		children
	}), $[37] = children, $[38] = t13, $[39] = t14) : t14 = $[39];
	let t15;
	return $[40] !== restProps || $[41] !== t12 || $[42] !== t14 ? (t15 = /* @__PURE__ */ jsx(StyledVirtualList, {
		as: t12,
		"data-ui": "VirtualList",
		...restProps,
		ref,
