 ...
 */
export function validateStudio(resource) {
    if (!resource)
        return [{ type: 'invalid_value', message: 'Studio config must be provided' }];
    if (typeof resource !== 'object')
        return [{ type: 'invalid_type', message: 'Studio config must be an object' }];
