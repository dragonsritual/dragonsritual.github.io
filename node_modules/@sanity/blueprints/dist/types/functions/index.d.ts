...
import type { BlueprintDocumentFunctionResourceEvent, BlueprintFunctionResourceContentLakeEvent, BlueprintMediaLibraryFunctionResourceEvent, BlueprintScheduledFunctionConfigEvent, BlueprintScheduledFunctionResourceEvent, BlueprintSyncTagInvalidateFunctionResourceEvent } from './event.js';
 ...
 * @interface
 */
export type BlueprintQueueFunctionConfig = Omit<BlueprintQueueFunctionResource, 'type' | 'src' | 'event'> & QueueConfig & {
    /**
     * Path to the function source code
     * @defaultValue `functions/${name}`
     */
